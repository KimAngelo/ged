            ...
            <div class="card-body">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control">
                                    <option value=""></option>
                                    <option>Adesão à Registro de Preços</option>
                ...
                <div class="mt-15">
                    <table class="table table-hover table-responsive-sm">
                        ...
                        <tr>
                            <th>60/2019</th>
                            <th>Tomada de Preço</th>
                            <th>1/2019</th>
                            <th>01/07/2019</th>
                            <th>
                                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                    <button title="Baixar documento" type="button" class="btn btn-primary font-weight-bold btn-sm"><i
